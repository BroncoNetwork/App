...
public class MainEntryLayout extends FrameLayout {
	...
	public MainEntryLayout(Context context) {
		super(context);
		
		initView();
	}
	
	public MainEntryLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		
		initView();
	}
	
	public MainEntryLayout(Context context, AttributeSet attrs, int defStyle) {
